...
2.  Turn on the bio safety hood and let it run for a minimum of 15 minutes before starting the protocol

3.  Make up a new batch of 10% bleach solution (1 part bleach to 9 parts distilled water) for the day and dispose of any from previous days

4.  Clean all pipettes and work surfaces (including inside the bio safety hood) first with the bleach solution, then distilled water, and finally with 70% ethanol

5.  Ensure that you have sufficient supplies (i.e., autoclaved, sterile tubes, pipette tips, etc.) before beginning

6.  Removed samples to be extracted from the freezer and let them thaw on ice
...
-   In this protocol, equipment/reagents available in the DNeasy PowerLyzer PowerSoil Kit will be marked in [blue]{style="color:blue"}. Equipment available in the SMAGL will be in [green]{style="color:green"}.
