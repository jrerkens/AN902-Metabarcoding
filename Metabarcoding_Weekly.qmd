...
ELP \# Protocol (**DNeasy PowerLyzer PowerSoil Kit)**
...
3.  Add 0.25 g of fecal matter to [PowerBead tubes]{style="color:blue"} (you will need to cut the tips off each pipette tip to make the point wide enough to be able to suck up the sample)
